...
def add_p12_certification():
    ...
    if verbose:
        ...
        print '========================================='
        subprocess.check_call('security list-keychains -s %s' % login_keychain)
    ...
    subprocess.check_call('security import %s -k %s -P %s -T /usr/bin/codesign' % (p12_file, login_keychain, p12_pass))
